 ...
 */
function createDrawingState(getCanvas, onImageChange) {
...
export function DrawingCanvas(props) {
    let canvasRef;
    let containerRef;
    const { color, setColor, brushSize, setBrushSize, startDrawing, draw, stopDrawing, clear, } = createDrawingState(() => canvasRef, props.onImageChange);
    onMount(() => {
    ...
    return (<div class="drawing-tool">
      <DrawingToolbar color={color()} brushSize={brushSize()} onColorChange={setColor} onBrushSizeChange={setBrushSize} onClear={clear}/>
