...
function createDrawingState(
    ...
    return { color, setColor, brushSize, setBrushSize, startDrawing, draw, stopDrawing, clear };
}
...
export function DrawingCanvas(props: DrawingCanvasProps) {
    ...
    const { color, setColor, brushSize, setBrushSize, startDrawing, draw, stopDrawing, clear } =
